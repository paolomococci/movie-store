        ...
        <b-form  @submit.stop.prevent="onSubmitForm">
          ...
          <b-form-group id="input-name-group" label="name" label-for="input-name">
            <b-form-input
              id="input-name"
              name="input-name"
              v-model="$v.form.countryName.$model"
              :state="onValidateCountryNameField('countryName')"
            ...
            <b-form-valid-feedback id="input-name-feedback-valid">
              the country name has a correct format
            </b-form-valid-feedback>
          </b-form-group>
          <!-- updated field -->
          <b-form-group id="country-updated-group" label="choose a date" label-for="country-updated-picker">
            <b-form-datepicker
              id="country-updated-picker"
              name="country-updated-picker"
              min="minDate"
              v-model="$v.form.countryUpdated.$model"
              :state="onValidateCountryUpdatedField('countryUpdated')"
              aria-describedby="country-updated-picker-description-feedback-invalid"
              menu-class="w-100"
              calendar-width="100%"
              class="mb-2"
              locale="en-US"
              v-b-popover.hover.top="'only today\'s or future date are accepted'"></b-form-datepicker>
            <b-form-invalid-feedback id="country-updated-picker-description-feedback-invalid">
              today or future date are accepted
            </b-form-invalid-feedback>
            <b-form-valid-feedback id="country-updated-picker-description-feedback-valid">
              the date all right
            </b-form-valid-feedback>
          </b-form-group>
          <!-- buttons -->
...
export default {
  ...
  methods: {
    ...
    addItem() {
      var data = {};
      CountryRestfulApiService.create(data)
        .then(response => {
