...
class CountryControllerSpec
        extends Specification
        implements ControllerUnitTest<CountryController>, DomainUnitTest<Country> {
    ...
    void "Test the save action correctly persists"() {
        ...
        request.json = new Country(params)
        controller.save()
    ...
    void "Test the update action correctly persists"() {
        ...
        request.method = 'PUT'
        populateValidParams(params)
        def instance = new Country(params)
        instance.id = 1
        instance.version = 0
