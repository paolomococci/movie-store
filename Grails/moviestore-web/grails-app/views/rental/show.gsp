...
<html>
    ...
    <body>
        ...
        <div id="show-rental" class="content scaffold-show" role="main">
            ...
            <f:display bean="rental" />
            <g:form resource="${this.rental}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.rental}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
